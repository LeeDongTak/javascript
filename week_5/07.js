...
class EvCar extends Car {
    constructor(nodelName, nodelYear, Price, chargeTime){
        // Car(부모클레스)에게도 알려주기!!
        super(nodelName, nodelYear, 'e', Price);
...
let evCar1 = new EvCar("테슬라",'2023',9000 , 60)

evCar1.makeNoise()
evCar1.printYear()
console.log(evCar1.chargeTime)
evCar1.chargeTime = 20
console.log(evCar1.chargeTime)
